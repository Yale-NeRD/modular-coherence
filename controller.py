...
x1 = threading.Thread(target=a1.requestor.run, args=())
x2 = threading.Thread(target=directory.run, args=())
x3 = threading.Thread(target=a2.invalidator.run, args=())
#daemon added to use sys.exit
x1.daemon = True
# x2.daemon = True
# x3.daemon = True

interconnect_object.controller_queues["a1"]["requestor"].append(("a1", "application", ("write", 0)))
...
time.sleep(8)
x4 = threading.Thread(target=a1.requestor.run, args=())
x5 = threading.Thread(target=directory.run, args=())
